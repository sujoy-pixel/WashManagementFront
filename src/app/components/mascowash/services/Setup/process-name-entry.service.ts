...
export class ProcessNameEntryService {
  ...
  GetFinMonth(actionType: string, finYear: string): Observable<any> {
    return this.http.get<any[]>(
      this.baseUrl_ +
        `Setup/dropdownfinancialmonth?actionType=${actionType}&finYear=${finYear}`,
      {
        headers: this.token.headerToken(),
      }
    );
  }
  GetFinMonthList(): Observable<any> {
    return this.http.get<any[]>(
      this.baseUrl_ + `Setup/dropdownfinancialmonthShow`,
      {
        headers: this.token.headerToken(),
      }
    );
  ...
  GetCashLcDetailData(
    CashLcMasterId: number,
    cashLcNo: string
  ): Observable<any> {
    return this.http.get<any[]>(
      this.baseUrl_ +
        'Setup/GetCashLcDetail?CashLcMasterId=' +
        CashLcMasterId +
        '&CashLcNo=' +
        cashLcNo,
      {
  ...
  GetJobByBuyerId(buyerId): Observable<any> {
    return this.http.get<any[]>(
      this.baseUrl_ +
        `Setup/GetDateWiseShipmentEntryJobIdByBuyerId?BuyerId=${buyerId}`,
      {
        headers: this.token.headerToken(),
      }
    );
